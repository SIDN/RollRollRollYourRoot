Fraction of vantage points (RIPE Atlas probe - recursive resolver pair) relying on recursive resolvers of large providers that see KSK-2017 using Root Canary measurements
